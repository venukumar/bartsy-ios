...
- (void)viewDidLoad
{
    ...
    UIButton *btnAgreement1=[self createUIButtonWithTitle:@"Beta Participant Agreement ->" image:nil frame:CGRectMake(30, 60, 260, 40) tag:111 selector:@selector(btnBeta_TouchUpInside:) target:self];
    ...
    UIButton *btnAgreement2=[self createUIButtonWithTitle:@"End User Licence Agreement ->" image:nil frame:CGRectMake(30, 120, 260, 40) tag:222 selector:@selector(btnBeta_TouchUpInside:) target:self];
    ...
    UIButton *btnAgreement3=[self createUIButtonWithTitle:@"Terms of Use ->" image:nil frame:CGRectMake(30, 180, 260, 40) tag:333 selector:@selector(btnBeta_TouchUpInside:) target:self];
    ...
    UIButton *btnAgreement4=[self createUIButtonWithTitle:@"Privacy Policy ->" image:nil frame:CGRectMake(30, 240, 260, 40) tag:444 selector:@selector(btnBeta_TouchUpInside:) target:self];
    ...
    UIButton *btnCheckbox=[self createUIButtonWithTitle:@"" image:[UIImage imageNamed:@"uncheck.png"] frame:CGRectMake(10, 300, 20, 20) tag:0 selector:@selector(btnCheckbox_TouchUpInside:) target:self];
    [self.view addSubview:btnCheckbox];
    
    UILabel *lblProfile=[self createLabelWithTitle:@"By checking this box I verify that I have read and agree to be bound by the above agreements." frame:CGRectMake(40, 295, 260, 60) tag:0 font:[UIFont systemFontOfSize:14] color:[UIColor blackColor] numberOfLines:3];
    lblProfile.textAlignment=NSTextAlignmentLeft;
    [self.view addSubview:lblProfile];
    

    
    UIButton *btnCancel=[self createUIButtonWithTitle:@"Quit" image:nil frame:CGRectMake(40, 365, 100, 40) tag:0 selector:@selector(btnCancel_TouchUpInside) target:self];
    ...
    UIButton *btnAccept=[self createUIButtonWithTitle:@"Accept" image:nil frame:CGRectMake(180, 365, 100, 40) tag:143225 selector:@selector(btnAccept_TouchUpInside) target:self];
